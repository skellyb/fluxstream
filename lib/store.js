...
var Store = (function () {
  function Store(key, core) {
    ...
    if (updaters && typeof updaters === 'object') {
      Object.keys(updaters).forEach(function (name) {
        ...
        _this._core.actions[name].subscribe(_this._handleUpdate.bind(_this, updaters[name]));
      });
    }
  ...
  _createClass(Store, [{
    ...
    key: 'shouldUpdate',
    value: function shouldUpdate(updatingState, currentState) {
      return true;
    }
  }, {
    key: 'onUpdate',
    ...
    key: '_validateUpdate',
    value: function _validateUpdate(updatingState, currentState) {
      return updatingState !== undefined && this.shouldUpdate(updatingState, currentState);
    }
  }, {
    key: '_handleUpdate',
    value: function _handleUpdate(updateHandler, payload) {
      var currentState = this._core.get(this._key);
      var updatingState = updateHandler(this._core, payload, currentState);
